...
public class OptionCli {
    ...
    OptionCli() {
        ...
        options.addOption("targetThreshold", true, "value of target threshold");
        options.addOption("intarvalsOfThreshold", true, "intarval of sampling");
        ...
        options.addOption("alpha", true, "value of alpha");
        options.addOption("gamma", true, "value of gamma");
    ...
    public void setArguments(Data d) {
        ...
        if ((str = cmdln.getOptionValue("targetThreshold")) != null)
            d.targetThreshold = Double.parseDouble(str);

        if ((str = cmdln.getOptionValue("intarvalsOfThreshold")) != null)
            d.intarvalsOfThreshold = Double.parseDouble(str);
        ...
        if ((str = cmdln.getOptionValue("alpha")) != null)
            d.alpha = Integer.parseInt(str);

        if ((str = cmdln.getOptionValue("gamma")) != null)
            d.gamma = Integer.parseInt(str);
    ...
    public void setFilename(Data d) {
        String str;
        Double th = Math.round(d.threshold * 100.0)/100.0; //小数点第三位で四捨五入

        str = "result/" + d.entityClass + "_" + String.valueOf(d.entity) + "_" + String.valueOf(th) + "_" + String.valueOf(d.step);
        d.file = new File((str.endsWith(".csv")) ? str : str.concat(".csv"));
    }
